...
Archived on 2026-08-14 because its deployment section still described the
retired Windows/Wine game server. Retained for rollback history; use
`docs/hosting.md` for current native operations.
