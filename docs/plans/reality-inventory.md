...
| 3 | **Creatures that can be hurt or that hurt you** | 1160/1161 `HealthState`, 1194/1195 `DamageDealer`, 1171 `MortalityState` — 61 unserved ids in all | ~6 | creatures are currently furniture. **Note §5.3.1: retail DELETED all creatures in U31, so this is a WAREBORN revival, not a restoration — and it does *not* gate #4**, because Bossa moved creature drops to scrap piles |
