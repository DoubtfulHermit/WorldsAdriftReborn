  ...
  Array.prototype.forEach.call(document.querySelectorAll('[data-observatory-mode-button]'),function(button){
    button.addEventListener('click',function(){navigateAdmin(button.dataset.observatoryModeButton,false,true);});
    button.addEventListener('keydown',function(e){
      ...
      e.preventDefault();navigateAdmin(modes[at],false,true);
    });
  });
